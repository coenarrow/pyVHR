...
class Dataset(metaclass=ABCMeta):
    ...
    def loadFilenames(self):
        ...
        for root, dirs, files in os.walk(self.BVPdataDIR):
            ...
            # Debugging prints
        print("Video directory:", self.videodataDIR)
        print("BVP directory:", self.BVPdataDIR)
        print("Video files found:", self.videoFilenames)
        print("BVP files found:", self.sigFilenames)
